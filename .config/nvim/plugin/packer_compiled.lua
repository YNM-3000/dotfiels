...
_G.packer_plugins = {
  ...
  ReplaceWithRegister = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/ReplaceWithRegister",
  ...
  ["git-conflict.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/git-conflict.nvim",
  ...
  ["goimpl.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/goimpl.nvim",
  ...
  neural = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/neural",
  ...
  ["typescript.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/typescript.nvim",
